...
func (r *Rest) MountEndPoint() {
	...
	user.PATCH("/profile/update", r.UpdateProfile)
	...
	owner.PATCH("/canteen/:canteen_id/update-status", r.UpdateCanteenStatus)
	...
	owner.PATCH("/order/:order_id/update-status", r.UpdateOrderStatus)
	owner.GET("/orders", r.GetOwnerAllOrders)
	owner.DELETE("/feedback/:feedback_id/delete", r.DeleteFeedback)
